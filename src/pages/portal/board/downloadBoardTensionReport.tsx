...
import { BoardTensionReportPDF } from "./BoardTensionReportPDF";
...
export async function downloadBoardTensionReport({
  report,
  scanLabel,
  scanTagline,
  organisation,
  ...
  const filename = safeFilename(`${orgName}_${scanLabel}_Cyntra`);

  const pdfDoc = (
    <BoardTensionReportPDF
      report={report}
      scanLabel={scanLabel}
