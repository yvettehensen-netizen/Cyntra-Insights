...
export default function ExecutiveDecisionCard({
  ...
  return (
    <section className="rounded-3xl border border-white/10 bg-[#0f141c] p-5" aria-label="Executive Decision Card">
      <header className="mb-4 flex flex-wrap items-center justify-between gap-2">
        <div>
          <p className="text-[11px] uppercase tracking-[0.28em] text-white/45">Executive Decision Card</p>
        ...
        <span className="rounded-lg border border-[#D4AF37]/60 bg-[#D4AF37]/20 px-3 py-1 text-sm font-semibold text-[#F3D983]">
          {card.confidence_pct.toFixed(1)}% confidence
        </span>
      </header>
      ...
      <div className="mt-3 grid gap-3 md:grid-cols-3">
        <article className="rounded-2xl border border-white/10 bg-[#0b1017] p-4">
          <p className="text-xs uppercase tracking-[0.18em] text-white/55">Irreversibility</p>
          <p className="mt-2 text-2xl font-semibold text-white">{decision.irreversibility_score.toFixed(1)}</p>
        </article>
        <article className="rounded-2xl border border-white/10 bg-[#0b1017] p-4">
          <p className="text-xs uppercase tracking-[0.18em] text-white/55">Ownership clarity</p>
          <p className="mt-2 text-2xl font-semibold text-white">{decision.ownership_clarity.toFixed(1)}</p>
        </article>
        <article className="rounded-2xl border border-white/10 bg-[#0b1017] p-4">
          <p className="text-xs uppercase tracking-[0.18em] text-white/55">Pattern cluster</p>
      ...
      <article className="mt-3 rounded-2xl border border-white/10 bg-[#0b1017] p-4">
        <p className="text-xs uppercase tracking-[0.18em] text-white/55">Executive narrative</p>
