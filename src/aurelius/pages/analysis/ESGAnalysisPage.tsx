...
export default function ESGAnalysis() {
  ...
  const downloadPDF = () => {
    if (!report) return;
    generateAureliusPDF(
      report.title ?? "ESG & Duurzaamheidsanalyse",
      report
    );
  };
    ...
    <div className="min-h-screen max-w-6xl mx-auto px-6 pt-32 pb-40 text-white">
      {loading && (
        <div className="mb-6 flex items-center gap-3 text-gray-400">
          ...
          <span>ESG-analyse wordt uitgevoerd…</span>
        </div>
      )}
        ...
        <div className="space-y-16">
          ...
          <Card className="bg-black/40 border-white/10">
            <CardContent className="p-8">
              <div
                className="prose prose-invert max-w-none whitespace-pre-wrap text-gray-200 leading-relaxed"
        ...
        <Card className="bg-black/40 border-white/10">
          <CardContent className="space-y-6 p-6">
            <h1 className="text-3xl font-bold text-[#D4AF37] flex items-center gap-3">
              ...
              ESG & Duurzaamheidsanalyse
            </h1>

            <p className="text-gray-400">
              Beschrijf de ESG-realiteit van de organisatie: milieu-impact,
              sociale verantwoordelijkheid, governance, ketenverantwoordelijkheid
              en mogelijke greenwashing-risico’s.
            </p>
            ...
            <textarea
              ...
              placeholder="Bijv: CO₂-reductie wordt extern geclaimd, maar supply chain is volledig fossiel. Governance is formeel ingericht, maar besluitvorming is niet transparant. ESG-rapportages missen onderliggende data…"
            />
            ...
            >
              {loading ? "Analyseren…" : "Start ESG Analyse"}
            </Button>
          </CardContent>
        </Card>
      )}
