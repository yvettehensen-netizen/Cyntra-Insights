...
export default function FinanceAnalysis() {
  ...
  const downloadPDF = () => {
    if (!report) return;
    generateAureliusPDF(
      report.title ?? "Financiële Analyse",
      report
    );
  };
    ...
    <div className="min-h-screen max-w-6xl mx-auto px-6 pt-32 pb-40 text-white">
      {loading && (
        <div className="mb-6 flex items-center gap-3 text-gray-400">
          ...
          <span>Financiële analyse wordt uitgevoerd…</span>
        </div>
      )}
        ...
        <Card className="bg-black/40 border-white/10">
          <CardContent className="space-y-6 p-6">
            ...
            <p className="text-gray-400">
              Beschrijf de financiële realiteit van de organisatie: omzet,
              marges, kostenstructuur, cashflow, schulden, investeringen en
              financiële risico’s.
            </p>
            ...
            <textarea
              ...
              placeholder="Bijv: Omzet groeit 8% YoY maar brutomarge daalt door stijgende kosten. Cashflow is negatief door voorfinanciering. Schulden beperken strategische bewegingsruimte..."
            />
            ...
            >
              {loading ? "Analyseren…" : "Start Financiële Analyse"}
            </Button>
          </CardContent>
        </Card>
      )}
