// src/aurelius/pages/analysis/SalesAnalysisPage.tsx
  ...
  const startAnalysis = async () => {
    ...
    try {
      ...
      const record = await runAurelius3({
        analysis_type: "sales", // ← EXACT zoals StrategyAnalysis
      ...
      const parsed = parseAureliusReport(record.report, "sales");
      setReport(parsed);
    } catch (err) {
      console.error("Salesanalyse fout:", err);
    }
  };
    ...
    <div className="min-h-screen max-w-6xl mx-auto px-6 pt-32 pb-40 text-white">
      {loading && (
        <div className="mb-6 flex items-center gap-3 text-gray-400">
          ...
          <span>Salesanalyse wordt uitgevoerd…</span>
        </div>
      )}
        ...
        <Card>
          <CardContent className="space-y-6 p-6">
            ...
            <textarea
              ...
              placeholder="Beschrijf pipeline, pricing, targets en closing…"
            />
            ...
            >
              {loading ? "Analyseren…" : "Start Sales Analyse"}
            </Button>
          </CardContent>
        </Card>
      )}
